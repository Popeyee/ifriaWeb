	...
	return(
		<div className=" flex flex-column">
			...
			<div className="title-cont">
				...
				<div className="flex justify-around flex-wrap pt5 ">	
					<div className="story-logo flex ">			
						<img className="big-logo grow " src={sl1} alt="logo" />
					<div className="flex flex-column  ">
						<img className="small-logo grow  " src={sl11} alt="logo" />
						<h6 className="w5 tj measure pt2 f6 tj">Years experience in Investment & Development Programming </h6>
					</div>
					</div>
					<div className="story-logo flex">
